...
* Explicação sobre o prompt:
	* O prompt acima foi usado para demonstrar como o ChatGPT gera subperguntas para entender melhor o problema e fornecer uma resposta mais específica. O GPT gerou 8 perguntas adicionais para obter detalhes que permitiriam uma resposta mais precisa.
